...
void ALERT(NSString* title, NSString* message) { 
	UIAlertView *_alert = [[UIAlertView alloc] initWithTitle:title message:message delegate:nil cancelButtonTitle:STRING_ALERT_OK otherButtonTitles:nil];  [_alert show]; [_alert release]; 
}
